...
def create_network2():
    net = WideResNet(widen_factor=2)
    return net
def create_network10():
    net = WideResNet()
    return net
def create_network10dropout():
    net = WideResNet(dropRate=0.3)
    return net
def create_network10dropout2():
    net = WideResNet(dropRate=0.2)
    return net
def create_network2dropout():
    net = WideResNet(widen_factor=2,dropRate=0.3)
    return net
if __name__ == '__main__':
    net = create_network2dropout()
    print(net)
